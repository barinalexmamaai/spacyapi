   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Collecting en-tuning-web-sm==3.2.0\n",
      "  Downloading https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.2.0/en_core_web_sm-3.2.0-py3-none-any.whl (13.9 MB)\n",
      "\u001b[K     |████████████████████████████████| 13.9 MB 5.2 MB/s eta 0:00:01\n",
      "\u001b[?25hRequirement already satisfied: spacy<3.3.0,>=3.2.0 in /home/barinale/.local/lib/python3.8/site-packages (from en-tuning-web-sm==3.2.0) (3.2.3)\n",
      "Requirement already satisfied: cymem<2.1.0,>=2.0.2 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (2.0.6)\n",
      "Requirement already satisfied: blis<0.8.0,>=0.4.0 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (0.7.6)\n",
      "Requirement already satisfied: wasabi<1.1.0,>=0.8.1 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (0.9.0)\n",
      "Requirement already satisfied: requests<3.0.0,>=2.13.0 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (2.27.1)\n",
      "Requirement already satisfied: srsly<3.0.0,>=2.4.1 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (2.4.2)\n",
      "Requirement already satisfied: pathy>=0.3.5 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (0.6.1)\n",
      "Requirement already satisfied: spacy-loggers<2.0.0,>=1.0.0 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (1.0.1)\n",
      "Requirement already satisfied: typer<0.5.0,>=0.3.0 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (0.4.0)\n",
      "Requirement already satisfied: tqdm<5.0.0,>=4.38.0 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (4.63.0)\n",
      "Requirement already satisfied: pydantic!=1.8,!=1.8.1,<1.9.0,>=1.7.4 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (1.8.2)\n",
      "Requirement already satisfied: preshed<3.1.0,>=3.0.2 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (3.0.6)\n",
      "Requirement already satisfied: catalogue<2.1.0,>=2.0.6 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (2.0.6)\n",
      "Requirement already satisfied: packaging>=20.0 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (21.3)\n",
      "Requirement already satisfied: spacy-legacy<3.1.0,>=3.0.8 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (3.0.9)\n",
      "Requirement already satisfied: numpy>=1.15.0 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (1.21.2)\n",
      "Requirement already satisfied: murmurhash<1.1.0,>=0.28.0 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (1.0.6)\n",
      "Requirement already satisfied: setuptools in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (58.0.4)\n",
      "Requirement already satisfied: jinja2 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (3.0.3)\n",
      "Requirement already satisfied: thinc<8.1.0,>=8.0.12 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (8.0.13)\n",
      "Requirement already satisfied: langcodes<4.0.0,>=3.2.0 in /home/barinale/.local/lib/python3.8/site-packages (from spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (3.3.0)\n",
      "Requirement already satisfied: pyparsing!=3.0.5,>=2.0.2 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from packaging>=20.0->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (3.0.7)\n",
      "Requirement already satisfied: smart-open<6.0.0,>=5.0.0 in /home/barinale/.local/lib/python3.8/site-packages (from pathy>=0.3.5->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (5.2.1)\n",
      "Requirement already satisfied: typing-extensions>=3.7.4.3 in /home/barinale/.local/lib/python3.8/site-packages (from pydantic!=1.8,!=1.8.1,<1.9.0,>=1.7.4->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (4.1.1)\n",
      "Requirement already satisfied: charset-normalizer~=2.0.0 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from requests<3.0.0,>=2.13.0->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (2.0.4)\n",
      "Requirement already satisfied: urllib3<1.27,>=1.21.1 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from requests<3.0.0,>=2.13.0->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (1.26.8)\n",
      "Requirement already satisfied: idna<4,>=2.5 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from requests<3.0.0,>=2.13.0->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (3.3)\n",
      "Requirement already satisfied: certifi>=2017.4.17 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from requests<3.0.0,>=2.13.0->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (2021.10.8)\n",
      "Requirement already satisfied: click<9.0.0,>=7.1.1 in /home/barinale/.local/lib/python3.8/site-packages (from typer<0.5.0,>=0.3.0->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (8.0.4)\n",
      "Requirement already satisfied: MarkupSafe>=2.0 in /home/barinale/miniconda3/envs/ner/lib/python3.8/site-packages (from jinja2->spacy<3.3.0,>=3.2.0->en-tuning-web-sm==3.2.0) (2.1.0)\n",
